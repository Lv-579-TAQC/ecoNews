...
public enum CreateNewsPageLocators implements BaseLocator{
    ...
    SOURCE_FIELD(new By.ByCssSelector("#main-content>div>div.form-container.ng-star-inserted>form>div.wrapper>div.left-form-column>div:nth-child(3)>label>input")),
